      ...
      <Container className="grid gap-0 px-0 lg:grid-cols-2">
        <FadeUp className="flex min-h-[420px] items-center justify-center border-b border-primary/10 bg-[#f8f9fc] p-12 dark:border-white/10 dark:bg-dark-bg lg:border-b-0 lg:border-r">
          <div className="relative h-[260px] w-[230px]">
            ...
            <div className="absolute bottom-0 left-4 flex h-28 w-44 items-center justify-center rounded-xl border border-primary/10 bg-white">
              <span className="font-serif text-xs uppercase tracking-[0.16em] text-text-muted">Pherada</span>
            </div>
        ...
        <FadeUp delay={0.08} className="flex flex-col justify-center px-6 py-16 md:px-12">
          <span className="text-xs font-bold uppercase tracking-[0.22em] text-accent">{t("home.simple.eyebrow")}</span>
          <h2 className="mt-4 font-serif text-5xl font-medium leading-tight text-text-dark dark:text-white md:text-6xl">
            {title}
          </h2>
          ...
          <div className="mt-8 flex gap-8 border-t border-primary/10 pt-6">
            {[
              ...
              <div key={label}>
                <p className="font-serif text-4xl font-light leading-none text-primary">{num}</p>
                <p className="mt-2 text-xs uppercase tracking-[0.08em] text-text-muted">{label}</p>
              </div>
            ))}
          </div>
        </FadeUp>
