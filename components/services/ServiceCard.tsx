  ...
  return (
    ...
    >
      <div className="mb-8 flex items-center justify-between">
        <span className="font-serif text-4xl font-medium leading-none text-primary dark:text-accent">
      ...
      <h3 className="font-serif text-[28px] font-medium leading-tight text-text-dark dark:text-white">{title}</h3>
