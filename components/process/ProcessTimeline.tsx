    ...
    <div className="relative">
      <div className="grid border border-primary/10 bg-white dark:border-white/10 dark:bg-white/[0.04] md:grid-cols-3">
        {steps.map((step, index) => (
          ...
          >
            <div className="mb-5 font-serif text-5xl font-medium leading-none text-primary dark:text-accent">
              {String(index + 1).padStart(2, "0")}
            </div>
            <h3 className="font-serif text-3xl font-medium text-text-dark dark:text-white">
