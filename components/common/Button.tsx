...
export function Button(props: LinkButtonProps | NativeButtonProps) {
  ...
  const classes = cn(
    "inline-flex min-h-11 items-center justify-center gap-2 rounded-[2px] px-8 py-3 text-xs font-semibold uppercase tracking-[0.1em] transition duration-200 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-transparent",
    variants[variant],
    className
  );
